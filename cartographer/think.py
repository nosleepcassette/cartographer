...
def _wire_graph(connection: sqlite3.Connection) -> dict[str, list[dict[str, Any]]]:
    ...
    for source_note, target_note, predicate, bidirectional, emotional_valence in rows:
        payload = {
...
def spreading_activation(
    ...
    *,
    ...
    while queue:
        current_note, activation, current_depth, path = queue.popleft()
        ...
        for edge in adjacency.get(current_note, []):
            ...
            queue.append((neighbor, next_activation, current_depth + 1, next_path))
